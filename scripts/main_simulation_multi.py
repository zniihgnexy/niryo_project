...
file_path = '/home/xz2723/niryo_project/llmAPI/task_1.txt'
task_list_1 = read_commands_from_file(file_path)
print(task_list_1)

file_path = '/home/xz2723/niryo_project/llmAPI/task_2.txt'
task_list_2 = read_commands_from_file(file_path)
print(task_list_2)
...
ball_position, ball_position_name, target_position, target_position_name = get_positions_for_this_command(task_list_1, chessboard_positions_list)
...
with viewer.launch_passive(model, data) as Viewer:
    ...
    print("calculating angle values for task 1...")
    print("Task list:", task_list_1)
    for task_name in task_list_1:
    ...
    ball_position, ball_position_name, target_position, target_position_name = get_positions_for_this_command(task_list_2, chessboard_positions_list)
    print("Ball position:", ball_position, "Ball position name:", ball_position_name)
    print("Target position:", target_position, "Target position name:", target_position_name)
    # print("Target position:", target_position)
    ...
    print("calculating angle values for task 2...")
    print("Task list:", task_list_2)
    for task_name in task_list_2:
        target_angles = get_task_name_and_target_angles(model, data, ball_position, target_position, initialize_angles, body_id, jacp, jacr, movable_joints_indices, task_name, ball_position_name, target_position_name)
        print("Target angles:", target_angles)
        angle_list.append(target_angles)
